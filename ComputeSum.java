...
public class ComputeSum {
  public static void main(String[] args){
     ...
     *
     */
    // TODO: maindelen skal der laves en brugerdialog og kald til metoden doMath
    // og doMath har en ufuldstændig signatur

  }
  doMath(number){
    int sum = 0;
    //TODO: split number op i passende dele (hint: modulus) og udregn tværsummen
    return sum;
  }
}
